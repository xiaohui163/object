...
$("#calculator-msg .title span").click(function(){
        ...
        calculate: function() {
            if (!cal.isPreInputEquals) {
                ...
                if (cal.isNumber(si)) {
                    ...
                    var proe= document.createElement("p");
                    proe .innerHTML = cal.getPreStep() + " " + si + " " + '=' + " " + cal.preResult;
                    var calculatorMsg = document.getElementById("jilu");
                    calculatorMsg.prepend(proe);

                    // console.log(cal.getPreStep() + " " + si + " " + '=' + " " + cal.preResult)
